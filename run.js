...
async function fetchData(baseUrl, cursor = "") {
...
async function processAPIsByFile() {
    ...
    log("Starting GitHub Actions update...");
    ...
    log(`GitHub Actions update complete - Duration: ${duration}s`);

    return { results, duration };
}

async function main() {
    log("Starting Enhanced EmoteSniper for GitHub Actions...");
